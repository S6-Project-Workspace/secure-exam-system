        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-4">
            <p className="text-sm text-slate-600">
              Step <span className="font-bold text-slate-900">2 of 4</span>: <span className="text-blue-600 font-semibold">Encrypt & Publish</span>
            </p>
            <p className="text-sm text-slate-500">Next: Attempt Configuration</p>
          </div>
          <div className="flex items-center gap-0">
            <div className="flex-1 h-1.5 bg-emerald-500 rounded-l-full"></div>
            <div className="flex-1 h-1.5 bg-blue-500"></div>
            <div className="flex-1 h-1.5 bg-slate-200"></div>
            <div className="flex-1 h-1.5 bg-slate-200 rounded-r-full"></div>
          </div>
          <div className="flex justify-between mt-2 text-xs font-medium">
            <span className="text-emerald-600">Create</span>
            <span className="text-blue-600">Encrypt</span>
          ...
          <div className="p-6 border-b border-slate-100">
            ...
            {isLoadingExams ? (
              ...
              <div className="flex items-center justify-between">
                ...
                {selectedExam && (
                  <span className={`px-3 py-1 rounded-full text-xs font-semibold ${isPublished ? 'bg-emerald-100 text-emerald-700' : 'bg-orange-100 text-orange-600'}`}>
                ...
                <div className="flex gap-3">
                  <div className="flex items-center gap-2 px-4 py-3 bg-slate-50 rounded-xl">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">Content encrypted at rest.</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2 px-4 py-3 bg-slate-50 rounded-xl">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">Verifies instructor origin.</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                {hasKeys && mcqs.length > 0 && (
                  <>
                    ...
                    <p className="text-xs text-slate-400 mt-3">
                      By clicking, you certify the integrity of this exam.
                    </p>
                  </>
                )}

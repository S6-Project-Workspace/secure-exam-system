...
export default function SecurityFooter() {
    return (
        <section className="mt-auto pt-6 pb-2">
            <div className="bg-blue-50 rounded-lg p-4 flex flex-col md:flex-row items-center justify-between border border-blue-100 gap-4">
                <div className="flex items-start md:items-center gap-3">
                    <div className="p-2 bg-blue-100 text-blue-900 rounded-full shrink-0">
                        <span className="material-symbols-outlined">shield_lock</span>
                    </div>
                    <div>
                        <h4 className="text-sm font-bold text-blue-900">System Security & Trust Protocols</h4>
                ...
                <div className="text-xs text-slate-400 border-t md:border-t-0 md:border-l border-slate-200 md:pl-4 pt-2 md:pt-0">

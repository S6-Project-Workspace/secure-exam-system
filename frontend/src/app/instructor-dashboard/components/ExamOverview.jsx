        ...
        <section className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">Manage, edit, and configure your examination papers.</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {exams.map((exam) => {
                    ...
                    return (
                        <div key={examId} className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                            <div className="p-5">
                                {/* Exam Code Badge */}
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button className="inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-sm font-medium rounded-lg transition-colors">
                ...
                >
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400 text-center">Start from scratch or import from previous semester.</p>
                </Link>
            </div>
        </section>
    );
